                ...
                <div class="swiper-wrapper">
                    <? foreach ($banner as $item) { ?>
                        <div class="swiper-slide">
                            <img class="w-100 main_banner" src="<?= $item->img_path ?>?>" alt="asd">
                            <div class="banner_context">
                                <h4 class="banner_context_title"><?= $item['title_' . \Yii::$app->language] ?></h4>
                                <h5 class="banner_context_text"><?= $item['text_' . \Yii::$app->language] ?></h5>
                            </div>
